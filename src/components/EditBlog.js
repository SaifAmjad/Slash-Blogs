...
const EditBlog = () => {
  ...
  const { blogs, insertImage, getSingleBlog, BlogCategories,editBlog } = context;
  ...
  const handleclick = async () => {
    try {
      ...
      const res = await editBlog(id,title, img, value, category);
      if (res.success) {
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-9 rounded rounded-5 bg-light mt-4 custom-writeblog-parentdiv">
              ...
              <input className="btn btn-success col-2 rounded-5 me-4 mt-5" type="submit" value="Update Blog" onClick={handleclick}/>
              </div>
            </div>
          </div>
