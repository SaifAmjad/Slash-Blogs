...
const Footer = () => {
  return (
    <div className="px-10 py-8" id="footer">
    <footer class="bg-black rounded-4xl">
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <h2 className="font-bold text-2xl text-white">Slash Blogs</h2>
                                      </a>

                    <p class="max-w-sm mt-2 text-gray-400">Join 31,000+ other and never miss out on new tips, tutorials, and more.</p>

                    <div class="flex mt-6 -mx-2">
                        <a href="#"
                            class="mx-2 transition-colors duration-300 text-gray-300 hover:text-pink-400"
                            aria-label="Reddit">
        ...
        <div>
            <p class="text-center text-gray-400">© Brand 2020 - All rights reserved</p>
        </div>
    </div>
</footer>
    </div>
