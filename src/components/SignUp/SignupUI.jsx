        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form class="w-full max-w-md">
            ...
            <div class="relative flex items-center mt-8">
              <span class="absolute">
                <svg
                  ...
                  className="w-7 h-7 mx-3 text-gray-300 dark:text-gray-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
                >
                  <path
                    ...
                    d="M5.121 17.804A9.003 9.003 0 0112 15c2.042 0 3.918.684 5.379 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"
                  />
                </svg>
              </span>
            ...
            <div class="mt-6">
              <PrimaryButton
                disabled={
                  signup?.email?.length > 0 && signup?.password?.length > 0
                    ? false
                    : true
                }
              ...
              <a
                href="#"
                className="flex items-center justify-center px-4 py-1.5 mt-4 text-gray-600 transition-colors duration-300 transform rounded-sm border border-gray-200 shadow-sm hover:bg-blue-100/50"
                onClick={googleLogin}
              >
                ...
                <span class="mx-1 text-sm">Sign up with Google</span>
              </a>
